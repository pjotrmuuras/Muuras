...
export default {
    [LOCALES.DUTCH]: {
       ...
       DinsdagData: {
        ...
        ChallengeData: {
            title: 'Winnaar van de Circular Challenge: Hoogbouw',
            date: 'April-Juni 2020',
            description: 'In Juni 2020 wonnen we de Circular Challenge: Hoogbouw van BlueCity. WSamen met het Hoogheemraadschap van Schieland en de Krimpenerwaard hebben we een in-house oplossing ontwikkeld om afvalwater in hoogbouw te hergebruiken.',
            button: 'Lees Verder'
        },
        banner: {
        ...
        swamp: {
            ...
            description: 'Muuras ontwikkelt groene verticale wetlandfilters die tal van milieuvoordelen kunnen opleveren.',
            button: 'Lees Verder'
        },
        teamInfo: {
            Gijs: {
                ...
                img: 'img/gijs.jpg',
                alt: 'Gijs',
                info: 'Gijs heeft diplomas in Circulaire Economie en Bos- en Natuurbescherming van EUC Rotterdam en Wageningen Universiteit. Met kennis over plantkunde, ecologie, en duurzaamheidsbeleid draagt hij bij aan de biodiversiteitsimpact van Muuras.'
            },
            Lydia: {
                name: 'Lydia',
                img: 'img/lydia.jpg',
        ...
        whatWeDo: {
            1: {
                title: 'De oer-delta aan het werk',
                text: 'Geïnspireerd door de wilde watersoorten in de Nederlandse delta en de prachtige groene gevels die wereldwijd gebouwd worden, kwamen we op het idee om een muur te ontwerpen die niet alleen mooi is, maar ook concrete voordelen biedt aan de gebruikers van het gebouw en de grotere stedelijke omgeving.'
             },
             2: {
                 title: 'Natuurlijke waterzuivering',
                 text: 'Afvalwater, zoals water dat na gebruik uit toiletten of gootstenen stroomt, stroomt door een systeem van plantenbakken met meerdere lagen lichtgewicht substraten. Het wortelmicrobioom filtert het afvalwater door interacties tussen fysieke processen, de zuiverende eigenschappen van het substraat en microbiële activiteit.'
              },
              3: {
                 title: 'Ruimte-efficiëncte klimaatadaptatie',
                 text: 'De herintroductie van inheemse plantensoorten in de stedelijke omgeving kan veel milieuvoordelen opleveren, zoals het verrijken van de lokale biodiversiteit, het opnemen van CO2, het bestrijden van het stedelijk hitte-eilandeffect en het besparen van water op een natuurlijke manier.'
              },
              4: {
                 title: 'Creatie van een gezonde leefomgeving',
                 text: 'Het plaatsen van een moeras aan je muur kan veel voordelen hebben voor je huis, flatgebouw en buurt. Ons verticale moeras helpt bij het isoleren van je woning, waardoor je bespaart op de energierekening en minder geluidsoverlast ervaart. Bovendien geniet je elke dag van een groene buurt met schone lucht en prachtige moerasplanten.'
              }
        },
        whatWeDoImgs: {
